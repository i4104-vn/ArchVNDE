...
sudo pacman -S --needed --noconfirm base-devel git pkgconf gtk4 gtk4-layer-shell rust labwc meson scdoc ninja playerctl 
git clone https://aur.archlinux.org/wlrctl.git
cd wlrctl
makepkg -si
