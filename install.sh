...
sudo pacman -S --needed --noconfirm base-devel git pkgconf gtk4 gtk4-layer-shell rust labwc meson ninja playerctl papirus-icon-theme grim wl-clipboard ttf-inter ttf-ubuntu-font-family ttf-jetbrains-mono-nerd otf-font-awesome
