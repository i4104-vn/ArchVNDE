...
/// Triggers a pure Rust genie-in animation by animating height request and opacity.
/// This completely avoids CSS transitions and CssProvider compilation issues.
...
/// Triggers a pure Rust genie-out animation by animating height request and opacity to 0.
    ...
    F: FnOnce() + 'static,
{
    ...
    widget.add_tick_callback(move |w_widget, clock| {
        ...
        w_widget.set_size_request(w, current_h);
