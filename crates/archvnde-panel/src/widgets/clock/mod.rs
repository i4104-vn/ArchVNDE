                    ...
                    if notifications.is_empty() {
                        ...
                        for app_key in app_order {
                            ...
                            if is_expanded {
                                ...
                                let icon_widget = archvnde_common::icon::get_icon_colored(&app_key, 18, "#3b82f6");
                                ...
                                for notif in list.iter().rev() {
                                    ...
                                    let icon_w = archvnde_common::icon::get_icon_colored(&app_key, 14, "rgba(255, 255, 255, 0.3)");
