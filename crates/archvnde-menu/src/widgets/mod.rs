...
pub fn build_menu_ui(app: &gtk4::Application) -> gtk4::ApplicationWindow {
    ...
    add_menu_item(
        &window,
        &menu_box,
        &archvnde_common::i18n::t("menu.terminal"),
        "terminal",
    ...
    add_menu_item(
        &window,
        &menu_box,
        &archvnde_common::i18n::t("menu.file_manager"),
        "folder",
    ...
    add_menu_item(
        &window,
        &menu_box,
        &archvnde_common::i18n::t("menu.change_wallpaper"),
        "display",
        Rc::new(move || {
    ...
    add_menu_item(
        &window,
        &menu_box,
        &archvnde_common::i18n::t("menu.reconfigure_shell"),
        "restart",
    ...
    add_menu_item(
        &window,
        &menu_box,
        &archvnde_common::i18n::t("menu.exit_shell"),
        "logout",
